...
<div class="col-sm-12" style="padding-top:10px;">
<input type="date" class="form-control" id="mobileno" placeholder="Due Date:" name="date" style="border-radius:15px;">
</div>
<div class="col-sm-12" style="padding-top:10px;">
<input type="time" class="form-control" id="password" placeholder="Type your Password"  name="time" style="border-radius:15px;">
</div>
